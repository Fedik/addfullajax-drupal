 ...
 *   +
 *   $regions = array that contain regions that need render (@see configuration)
 *   $main_region = string, region name that contain main contant (@see configuration)
 *   $content_id = CSS id of main block content(@see configuration)
 */
?>
